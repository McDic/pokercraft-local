...
RR_PLOT_TITLE: typing.Final[str] = "Relative Prize Returns"
RR_PLOT_SUBTITLE: typing.Final[str] = "(RR = Prize / Buy-in / (1 + Re-entries))"
BANKROLL_PLOT_TITLE: typing.Final[str] = (
    "Bankroll Analysis with " "Monte-Carlo Simulation based on RR"
)
...
TRANSLATION: typing.Final[dict[Language, dict[str, str]]] = {
    Language.KOREAN: {
        ...
        RR_PLOT_TITLE: "바인 금액 대비 상대적 리턴",
        RR_PLOT_SUBTITLE: "(RR = 상금 / 바인금액 / (1 + 리엔트리수))",
        ...
        # Bankroll Analysis
        BANKROLL_PLOT_TITLE: "RR 기반 몬테카를로 시뮬레이션을 통한 뱅크롤 분석",
        BANKROLL_PLOT_SUBTITLE: "이 그래프는 당신의 성적이 수익적인 경우에만 계산됩니다.",
        "Metric": "메트릭",
