...
TOURNEY_SUMMARY_TITLE_FRAME: typing.Final[
    str
] = "%s's realistic tournament performance on GGNetwork"
HAND_HISTORY_TITLE_FRAME: typing.Final[str] = "%s's GGNetwork hand history analysis"
...
GUI_EXPORTED_SUCCESS_TOURNEY_SUMMARY: typing.Final[str] = (
    "Exported CSV and plot successfully; "
    "Please check {csv_path} and {plot_path} in {output_dir}."
)
GUI_EXPORTED_SUCCESS_HAND_HISTORY: typing.Final[
    str
] = "Exported plot successfully; Please check {plot_path} in {output_dir}."
...
TRANSLATION: typing.Final[dict[Language, dict[str, str]]] = {
    Language.KOREAN: {
        # Title and credits
        TOURNEY_SUMMARY_TITLE_FRAME: "%s님의 GGNetwork 토너먼트에서의 현실적인 성적",
        ...
        GUI_EXPORTED_SUCCESS_HAND_HISTORY: (
            "그래프 파일이 성공적으로 생성되었습니다. "
            "{output_dir} 안에 있는 {plot_path}를 확인해주세요."
        ),
